...
\item Are $Y_A$ and $Y_B$ independent? Confirm your answer with simulations (ChatGPT allowed).
\end{enumerate}
...
%--------------------------------------------------------------------------------------------------------------------------------
\begin{exercise}[Conditional probability from a table]
Suppose you have the following joint probability table for random variables $A$ and $B$:
\begin{center}
\begin{tabular}{c|cc}
 & $B=0$ & $B=1$ \\
\hline
...
\item What is $P(B=1|A=0)$?
\end{enumerate}
\end{exercise}

%--------------------------------------------------------------------------------------------------------------------------------
\begin{exercise}[Conditional probability from a piecewise function]
...
\end{cases}
\end{equation*}
Let $Y|X$ be defined as $Y|X=x \sim \text{Bernoulli}(x/4 + 1/4)$.
\begin{enumerate}[label=(\alph*)]
